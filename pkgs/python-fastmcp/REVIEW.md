...
| 2026-07-24 | 3.4.4-2 | (this PR) | — (pkgrel bump のみ) | `pkgrel` +1 (cascade: [nekono] dep rebuilt): python-py-key-value-aio 0.4.4-19 → 0.4.4-20 rebuild に追随 (build-all の cascade-warn 由来) |
...
| 2026-08-30 | 3.4.7-2 | (this PR) | — (pkgrel bump のみ) | `pkgrel` +1 (cascade: [nekono] dep rebuilt): python-cyclopts 4.22.5-1 → 4.23.3-1 + python-py-key-value-aio 0.4.4-28 → 0.4.4-29 rebuild に追随 (build-all の cascade-warn 由来) | |
