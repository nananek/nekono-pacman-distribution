...
|---|---|---|---|---|
| 2026-08-15 | 1.1.4-8 | (this PR) | — (pkgrel bump のみ) | `pkgrel` +1 (deps changed): python 3.14.6-1 \u2192 3.14.7-1 |
...
| 2026-06-21 | 1:1.1.4-6 | `(this PR)` | — (pkgrel bump のみ) | `pkgrel` +1 (deps changed): python 3.14.5-1 → 3.14.6-1 |
| 2026-08-09 | 1:1.1.4-7 | bot PR #505 | — (pkgrel bump のみ) | `pkgrel` +1 (deps changed): python-packaging 26.2-1 → 26.3-1 |
