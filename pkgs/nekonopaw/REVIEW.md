...
|---|---|---|---|---|
| 2026-08-15 | 0.1.2-8 | (this PR) | — (pkgrel bump のみ) | `pkgrel` +1 (deps changed): go 2:1.26.5-1 → 2:1.26.6-1 |
...
| 2026-06-21 | 0.1.2-5 | (this PR) | — (pkgrel bump のみ) | `pkgrel` +1 (deps changed): pipewire 1:1.6.6-1 → 1:1.6.7-1 |
| 2026-07-09 | 0.1.2-6 | bot PR #366 | — (pkgrel bump のみ) | `pkgrel` +1 (deps changed): go 2:1.26.4-1 → 2:1.26.5-1 |
| 2026-07-15 | 0.1.2-7 | (this PR) | — (pkgrel bump のみ) | `pkgrel` +1 (deps changed): pipewire 1:1.6.7-1 → 1:1.6.8-1 |
| 2026-08-21 | 0.1.2-9 | (this PR) | — (pkgrel bump のみ) | `pkgrel` +1 (deps changed): go 2:1.26.6-1 → 2:1.27.0-1 |
