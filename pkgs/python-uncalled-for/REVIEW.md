...
AUR の `python-uncalled-for` PKGBUILD (pkgver=0.2.0, pkgrel=1) を fork。 純 fork
...
|---|---|---|---|---|
| 2026-05-19 | 0.2.0 | (初回 PR commit SHA、 push 後に固定) | `b39a1115e11db09533461df5341e1c78a583a80d` | 初回 add、 純 fork (= prepare()/check() 削除のみ) |
