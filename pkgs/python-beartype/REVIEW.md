...
| 2026-05-20 | 0.22.9-2 | (本 PR の commit SHA、 push 後に固定) | (同上) | `pkgrel` +1: checkdepends に `python-poetry` 追加 (= AUR PKGBUILD 漏れの test_poetry 通過用、 build host で実測 fail を確認、 全 dep Arch 公式で揃う) |
