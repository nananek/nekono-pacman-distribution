...
| 2026-05-31 | 0.25.2-6 | bot PR #141 | — (pkgrel bump のみ) | `pkgrel` +1 (deps changed): nvidia-utils 595.71.05-2 → 610.43.02-2 (libcuda.so.1 driver userspace のみ、 bundle 同梱 CUDA 11 stack には影響なし) |
| 2026-06-03 | 0.25.2-7 | (this PR) | — (pkgrel bump のみ) | `pkgrel` +1 (deps changed): python-pip 26.1.1-1 → 26.1.2-1 |
| 2026-06-05 | 0.25.2-8 | bot PR #170 | — (pkgrel bump のみ) | `pkgrel` +1 (deps changed): python-python-multipart 0.0.29-1 → 0.0.31-1 |
| 2026-06-07 | 0.25.2-9 | bot PR #183 | — (pkgrel bump のみ) | `pkgrel` +1 (deps changed): python-python-multipart 0.0.31-1 → 0.0.32-1 |
...
| 2026-06-28 | 0.25.2-14 | bot PR #305 | — (pkgrel bump のみ) | `pkgrel` +1 (deps changed): 7zip 26.01-1 → 26.02-1、 gcc 16.1.1+r12 → 16.1.1+r346、 nvidia-utils 610.43.02-2 → 610.43.02-3 (libcuda.so.1 driver userspace のみ、 bundle 同梱 CUDA 11 stack には影響なし) |
| 2026-06-29 | 0.25.2-15 | bot PR #308 | — (pkgrel bump のみ) | `pkgrel` +1 (deps changed): python-fastapi 0.138.0-1 → 0.138.1-1 |
| 2026-06-30 | 0.25.2-16 | bot PR #309 | — (pkgrel bump のみ) | `pkgrel` +1 (deps changed): cython 3.2.6-1 → 3.2.6-2 |
| 2026-07-01 | 0.25.2-17 | bot PR #319 | — (pkgrel bump のみ) | `pkgrel` +1 (deps changed): cython 3.2.6-2 → 3.2.8-1 |
| 2026-07-06 | 0.25.2-18 | bot PR #348 | — (pkgrel bump のみ) | `pkgrel` +1 (deps changed): python-fastapi 0.138.1-1 → 0.139.0-1, python-numpy 2.5.0-1 → 2.5.1-1 |
| 2026-07-09 | 0.25.2-19 | bot PR #368 | — (pkgrel bump のみ) | `pkgrel` +1 (deps changed): python-setuptools 1:82.0.1-1 → 1:83.0.0-1 |
