...
|---|---|---|---|---|
| 2026-08-16 | 0.4.4-28 | (this PR) | — (pkgrel bump のみ) | `pkgrel` +1 (deps changed): python-uv-build 0.12.3-1 → 0.12.5-1 |
| 2026-08-15 | 0.4.4-27 | (this PR) | — (pkgrel bump のみ) | `pkgrel` +1 (deps changed): python 3.14.6-1 → 3.14.7-1, python-wheel 0.47.0-1 → 0.48.0-1 |
...
| 2026-07-23 | 0.4.4-19 | bot PR #431 | — (pkgrel bump のみ) | `pkgrel` +1 (deps changed): python-uv-build 0.11.30-1 → 0.11.31-1 |
